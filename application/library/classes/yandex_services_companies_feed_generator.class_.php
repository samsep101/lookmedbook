<?php
	...
	{
		private $dom_document_instance;
		private $companies_node;
		private $static_service_only_flag;

		private $book_mode = 'static';
		private $home_resource = 0;
...
*/
		...
		public function generate($feed_version)
		{
			...
			foreach($clinics as $clinic)
			{
                ...
                if ($static_match) {
                    if ($feed_version == 1 || $feed_version == 3) {
        ...
        private function createCompanyFeatureNode($node, $element, $name, $value)
        {
        ...
        private function replaceIllegalCharacters($text) {
