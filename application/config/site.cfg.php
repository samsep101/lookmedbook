...
define('SHOP_ENABLE', 0);
define('RELEASE_NUMBER', 44);

if ($_SERVER['HTTP_HOST'] == 'sankt-peterburg.' . SITE_DOMAIN) {
    define('SITE_PHONE_CODE', '812');
    define('SITE_PHONE', '416-01-84');
} elseif ($_SERVER['HTTP_HOST'] == SITE_DOMAIN) {
    define('SITE_PHONE_CODE', '495');
    define('SITE_PHONE', '431-68-17');
} else {
...
define('JUR_ADDRESS', 'ул. Складочная, д. 1, стр. 18, подъезд 12, этаж 2, офис 208/1');
define('JUR_ADDRESS_FULL', '127018, г. Москва, ул. Складочная, д. 1, стр. 18, подъезд 12, этаж 2, офис 208/1');
define('CONTENT_DISEASE_URL', 'http://admin:D[jlLkzFlvbyf18@content.'.SITE_DOMAIN.'/media/xml/Test.xml');
...
define('LANDING_PHONE', '+7 (495) 431-68-17');
define('FOOTER_PHONE', '+7 (495) 431-68-17');
